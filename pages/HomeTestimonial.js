...
function HomeTestimonial() {
  ...
  const handleClose = () => setOpen(false);
    ...
    const [updateHomeTestimonial, setupdateHomeTestimonial] = useState({
      title: "",
      category: "",
      content: "",
      image: "",
    });
    const [updateHomeTestimonialErrors, setupdateHomeTestimonialErrors] = useState({
      title: "",
      category: "",
      image: "",
      content: "",
